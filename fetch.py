#!/usr/bin/env python3
"""
Recupero codici sconto Vision Direct da shopilo.it
Sursa: https://shopilo.it/negozi/visiondirect.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/visiondirect.it"
STORE_NAME = "Vision Direct"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Vision Direct da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-visiondirect)"
    }
    try:
